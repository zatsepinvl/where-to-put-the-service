package com.effective.ecommerce.yetanother.testutils;
...
public class PostgresContainerTestConfig {
    ...
    @Bean
    public DataSource dataSource(JdbcDatabaseContainer<?> jdbcDatabaseContainer) throws ClassNotFoundException {
